...
##########################		Lists			############################
listMageWeapons = ["Johktari Hunting Knife","Rod of the Arcanum","Hellstar","Resplendent Bow", "Shiftratar", "Ivarium Halberd", "Thorn Whip", "Elemental Staff", "Bo Staff", "Sacrificial Blade"]
