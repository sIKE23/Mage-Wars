...
@echo.
powershell -command unblock-file .\MWPlugIn\Octgn.Magewars.dll && @echo   - It is not Blocked.....

@echo.
@echo Making sure that the folder where we want to install the plugin exists and if it doesn't we will create it...
@echo.
if exist ..\..\Plugins\Octgn.MagewarsPlugin (@echo   - Folder already exists!) else (mkdir ..\..\Plugins\MWPlugIn & @echo   - Target folder was created!) 
@echo.
